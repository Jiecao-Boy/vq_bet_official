...
def vit_small(stop_grad_conv1=True, pretrained=None, output_dim=384, **kwargs):
...
def vit_base(stop_grad_conv1=True, pretrained=None, output_dim=384, **kwargs):
    model = VisionTransformerMoCo(
        patch_size=16,
        embed_dim=768,
        depth=12,
...
def vit_conv_small(stop_grad_conv1=True, pretrained=None, output_dim=384, **kwargs):
    # minus one ViT block
    model = VisionTransformerMoCo(
        patch_size=16,
        embed_dim=384,
...
def vit_conv_base(stop_grad_conv1=True, pretrained=None, output_dim=384, **kwargs):
    # minus one ViT block
    model = VisionTransformerMoCo(
        patch_size=16,
        embed_dim=768,
